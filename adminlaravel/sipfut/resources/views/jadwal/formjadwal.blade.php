...
@section('content')
    <div class="container col-6">
        <div class="box-body">
            <form action="{{ route('jadwal_lapangans.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="waktu" class="form-control" id="exampleFormControlInput1"
